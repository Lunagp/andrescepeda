...
public class EventsHome {
  ...
  //  public static final Target BTN_EVENTS = Target.the("Botón opción eventos").located(By.xpath("//a[contains(text(),'EVENTOS')]"));
    public static final Target BTN_NEXTEVENTS = Target.the("Botón opción próximos eventos").located(By.xpath("//a[contains(text(),'PRÓXIMOS eventos')]"));
    ...
    public static final Target TXT_TICKET = Target.the("btn ticket").located(By.xpath("//span[contains(text(),'Nov 5, 2022')]"));
}
